...
export interface definitions {
	/** Base data table for user profiles, extending the default supabase auth.users table. */
	profiles: {
		/**
		 * Format: uuid
		 *
	...
	/** Table for managing editing rights on a per-project basis for non-creators. */
	projects_editors: {
		/**
		 * Format: integer
		 *
		 ...
		 * Format: integer
		 *
		 * Note: This is a Foreign Key to `projects.id`.<fk table='projects' column='id'/>
		 */
		project_id: number;
		/** Format: uuid */
		user_id: string;
	};
	/** Table for managing projects publication status. */
	projects_publication_status: {
		/**
		 * Format: integer
		 *
		 * Note: This is a Primary Key.<pk/> This is a Foreign Key to `projects.id`.<fk table='projects' column='id'/>
		 */
		project_id: number;
		/**
		 * Format: timestamp with time zone
		 ...
		 * @enum {string}
		 */
		status: 'unpublished' | 'awaiting_approval' | 'revoked_approval' | 'published';
	};
	projects_ratings: {
		/**
		 * Format: integer
	...
	users_projects_collections_items: {
		 ...
		 * Format: integer
		 *
		 * Note: This is a Foreign Key to `users_projects_collections.id`.<fk table='users_projects_collections' column='id'/>
		 */
	...
	/** Table for controlled access to users roles. */
	users_roles: {
		/**
		 * Format: uuid
		 *
