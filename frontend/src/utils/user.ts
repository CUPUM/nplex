/**
 * List of roles declared in supabase and associated with users. The enum's values should ALWAYS correspond to the
 * possible values of the database's user_role enum. Useful to compare the current $session.user.role to various guards
 * across the app.
 */
 ...
 */
export const allRoles = Object.values(UserRole) as UserRole[];
