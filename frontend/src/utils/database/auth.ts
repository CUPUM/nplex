...
type SignupDetails = any; // Pick<UserCredentials, 'email' | 'password'> | Pick<UserCredentials, 'provider'>;
...
type LoginDetails = any; // Pick<UserCredentials, 'email' | 'password'> | Pick<UserCredentials, 'provider'>;
