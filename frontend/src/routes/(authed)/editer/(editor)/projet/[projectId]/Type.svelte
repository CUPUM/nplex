...
<Dirty sample={type_id} specimen={$editTypeId} bind:dirty={$editorDirty.type_id} />
<EditorFormgroup legend="Type de projet">
	<Switch style="align-self: flex-start" variant="default" bind:group={$editTypeId} name="type_id">
