...
<script lang="ts">
	...
	/**
	 * CSS inline style for the figure (outer container) element. Default style includes display flex to allow for easy
	 * centering of map when bigger than container.
	 */
	export let style: string = undefined;
	/**
	 * CSS inline style for the map element, useful to implement overflow. The map container is display flex to allow
	 * for easy centering.
	 */
