...
<script lang="ts" context="module">
	const LOGO_SYMBOLS_IDS = {
		n: 'nplex-logo-n',
		p: 'nplex-logo-p',
		l: 'nplex-logo-l',
		e: 'nplex-logo-e',
		x: 'nplex-logo-x',
		full: 'nplex-logo-full',
		monogram: 'nplex-logo-mono',
	};
	...
	export const LOGO_SYMBOLS_HREFS = {
		n: href(LOGO_SYMBOLS_IDS.n),
		p: href(LOGO_SYMBOLS_IDS.p),
		l: href(LOGO_SYMBOLS_IDS.l),
		e: href(LOGO_SYMBOLS_IDS.e),
		x: href(LOGO_SYMBOLS_IDS.x),
		full: href(LOGO_SYMBOLS_IDS.full),
...
<svg xmlns="http://www.w3.org/2000/svg">
	...
	<symbol id={LOGO_SYMBOLS_IDS.full} viewBox={LOGO_VIEWBOX}>
		...
		<use href={LOGO_SYMBOLS_HREFS.e} />
		<use href={LOGO_SYMBOLS_HREFS.x} />
	</symbol>
	<symbol id={LOGO_SYMBOLS_IDS.monogram} viewBox={MONOGRAM_VIEWBOX}>
		<use href={LOGO_SYMBOLS_HREFS.n} />
	</symbol>
</svg>
