...
/**
 * Transition stylized such to evoke a scaffolding / building / unfolding process.
 */
export function scaffold(el: Element, { delay = 0, duration = 350, opacity = 1, easing = expoOut }) {
