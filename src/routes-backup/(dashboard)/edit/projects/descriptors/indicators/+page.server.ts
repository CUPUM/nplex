...
import { toExcluded } from '$lib/db/custom-types.server';
				...
				await Promise.all([
					...
					tx
						...
						.onConflictDoUpdate({
							...
							set: toExcluded(projectExemplarityIndicatorsTranslations),
						}),
				]);
			});
		} catch (e) {
				...
				await Promise.all([
					...
					tx
						...
						.onConflictDoUpdate({
							...
							set: toExcluded(projectExemplarityCategoriesTranslations),
						}),
				]);
			});
		} catch (e) {
