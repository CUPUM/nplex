...
<article class="group/card bg-card rounded-card absolute inset-0">
	...
	{/if} -->
	<div class="p-card-padding relative z-1 flex">
		{project.id}
	</div>
	<!-- svelte-ignore a11y_missing_content -->
	<a class="fill" use:ripple {...linkAttributes(`/projects/${project.id}`)}></a>
</article>
