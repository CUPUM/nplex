...
>
	{#each data.guides as guide, i (guide.slug)}
		<a
			class="group/card p-section-padding bg-card/softer rounded-section group/card duration-fast hover:bg-card relative aspect-[2/1] w-[50%] max-w-full min-w-sm flex-none backdrop-blur-md transition-all ease-out"
		...
		>
			<div class="flex size-full flex-col gap-[1em]">
				...
				<p class="opacity-softer leading-lg max-w-xs text-sm">
