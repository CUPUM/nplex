...
<DashboardSubSection>
	...
	>
		<label
			class="p-padding border-base/softer rounded-input group/button relative flex aspect-square cursor-pointer items-center justify-center border border-dashed"
			use:ripple
		>
