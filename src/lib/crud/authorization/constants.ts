...
export const PERMISSIONS = {
	...
	'projects.descriptors.exemplarityMarkers.create': [ROLES.EDITOR, ROLES.ADMIN],
	'projects.descriptors.exemplarityMarkers.update': [ROLES.EDITOR, ROLES.ADMIN],
	'projects.descriptors.exemplarityMarkers.delete': [ROLES.EDITOR, ROLES.ADMIN],
