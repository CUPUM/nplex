...
CREATE TABLE IF NOT EXISTS "accounts"."users" (
	"id" text PRIMARY KEY DEFAULT "extensions"."nanoid"(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS "accounts"."users_notifications" (
	"id" text PRIMARY KEY DEFAULT "extensions"."nanoid"(21) NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "project_building_level_type" (
	"id" text PRIMARY KEY DEFAULT "extensions"."nanoid"(6) NOT NULL,
	"vertical_index" integer NOT NULL,
	"is_ground_level" boolean,
	CONSTRAINT "project_building_level_type_is_ground_level_unique" UNIQUE("is_ground_level")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "project_building_level_types_t" (
	"id" text,
	"locale" text NOT NULL,
	"title" text,
	"description" text,
	CONSTRAINT project_building_level_types_t_id_locale PRIMARY KEY("id","locale")
);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "projects" (
	...
	"cost_range" "int4",
	"site_area" integer,
	"interventions_area" integer,
	"building_area" integer,
	"building_construction_date" date
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "projects_building_levels" (
	"id" text PRIMARY KEY DEFAULT "extensions"."nanoid"(21) NOT NULL,
	"project_id" text,
	"level_type_id" text,
	"vertical_index" integer NOT NULL,
	"height" integer,
	CONSTRAINT "projects_building_levels_vertical_index_project_id_unique" UNIQUE("vertical_index","project_id")
);
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "projects_exemplarity_indicators" (
	"project_id" text NOT NULL,
	"exemplarity_indicator_id" text NOT NULL,
...
CREATE TABLE IF NOT EXISTS "projects_images" (
	...
	CONSTRAINT "projects_images_project_id_is_banner_unique" UNIQUE("project_id","is_banner")
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "projects_views" (
	"id" text PRIMARY KEY DEFAULT "extensions"."nanoid"(21) NOT NULL,
	"project_id" text NOT NULL,
	"user_id" text,
	"client_id" text,
	"viewed_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "projects_views_project_id_user_id_unique" UNIQUE("project_id","user_id"),
	CONSTRAINT "projects_views_project_id_client_id_unique" UNIQUE("project_id","client_id")
);
--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "project_building_level_types_t" ADD CONSTRAINT "project_building_level_types_t_id_project_building_level_type_id_fk" FOREIGN KEY ("id") REFERENCES "project_building_level_type"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "project_building_level_types_t" ADD CONSTRAINT "project_building_level_types_t_locale_locales_locale_fk" FOREIGN KEY ("locale") REFERENCES "i18n"."locales"("locale") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projects_building_levels" ADD CONSTRAINT "projects_building_levels_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projects_building_levels" ADD CONSTRAINT "projects_building_levels_level_type_id_project_building_level_type_id_fk" FOREIGN KEY ("level_type_id") REFERENCES "project_building_level_type"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projects_views" ADD CONSTRAINT "projects_views_project_id_projects_id_fk" FOREIGN KEY ("project_id") REFERENCES "projects"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "projects_views" ADD CONSTRAINT "projects_views_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "accounts"."users"("id") ON DELETE cascade ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
