...
create table public.users_roles (
	user_id uuid references public.users on delete cascade not null primary key unique,
	updated_at timestamptz default timezone('utc'::text, now()) not null,
...
create table public.projects (
	...
	created_at timestamptz default timezone('utc'::text, now()) not null,
	updated_at timestamptz default timezone('utc'::text, now()) not null,
	created_by_id uuid references public.users default auth.uid() not null,
	updated_by_id uuid references public.users default auth.uid() not null,
...
create table public.projects_publication_status (
	...
	updated_at timestamptz default timezone('utc'::text, now()) not null,
	updated_by_id uuid references public.users not null,
