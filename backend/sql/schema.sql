...
create table public.project_site_ownership_list (
	id int2 generated by default as identity primary key unique,
	title text not null,
	description text
);

insert into public.project_site_ownership_list (title, description)
values ('Particulier', ''),
...
create table public.project_site_usage_category_list (
	id int2 generated by default as identity primary key unique,
	title text not null,
	description text
);

insert into public.project_site_usage_category_list (title, description)
values ('Résidentiel', ''),
	('Communautaire', ''),
	('Commercial', ''),
	('Industriel', '');
...
-- PLACE USAGE LIST
create table public.project_site_usage_list (
	id int2 generated by default as identity primary key unique,
	title text not null,
	description text
);

insert into public.project_site_usage_list (title, description)
values ('Unifamilial', ''),
	('Duplex', ''),
	('Triplex', ''),
	('Quadruplex', ''),
