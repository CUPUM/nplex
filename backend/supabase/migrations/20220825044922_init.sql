...
create table "public"."projects_users" (
    ...
    "created_by_id" uuid not null default auth.uid(),
    "modified_by_id" uuid not null default auth.uid()
);
...
create table "public"."users_profiles" (
    ...
    "updated_at" timestamp with time zone not null default now(),
    "avatar_url" text,
    "firstname" text not null default 'Anonyme'::text,
    "middlename" text,
    "lastname" text,
    "about" text,
    "public_email" text,
...
CREATE UNIQUE INDEX projects_ratings_pkey ON public.projects_likes USING btree (id, user_id, project_id);

CREATE UNIQUE INDEX projects_ratings_project_id_user_id_key ON public.projects_likes USING btree (project_id, user_id);

CREATE UNIQUE INDEX projects_ratings_user_id_project_id_key ON public.projects_likes USING btree (user_id, project_id);
...
alter table "public"."projects_likes" add constraint "projects_ratings_pkey" PRIMARY KEY using index "projects_ratings_pkey";
...
alter table "public"."project_event_child_type" add constraint "project_event_child_type_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."project_event_child_type" validate constraint "project_event_child_type_created_by_id_fkey";
...
alter table "public"."project_event_child_type" add constraint "project_event_child_type_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."project_event_child_type" validate constraint "project_event_child_type_updated_by_id_fkey";

alter table "public"."project_event_type" add constraint "project_event_type_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."project_event_type" validate constraint "project_event_type_created_by_id_fkey";

alter table "public"."project_event_type" add constraint "project_event_type_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."project_exemplarity_indicator" add constraint "project_exemplarity_indicator_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."project_exemplarity_indicator" validate constraint "project_exemplarity_indicator_created_by_id_fkey";

alter table "public"."project_exemplarity_indicator" add constraint "project_exemplarity_indicator_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."project_exemplarity_indicator" validate constraint "project_exemplarity_indicator_updated_by_id_fkey";

alter table "public"."project_exemplarity_indicator_category" add constraint "project_exemplarity_indicator_category_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."project_exemplarity_indicator_category" add constraint "project_exemplarity_indicator_category_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."project_material_type" add constraint "project_material_type_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."project_material_type" add constraint "project_material_type_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."project_material_type" validate constraint "project_material_type_updated_by_id_fkey";

alter table "public"."project_material_use" add constraint "project_material_use_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."project_material_use" add constraint "project_material_use_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_events" add constraint "projects_events_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_events" add constraint "projects_events_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."projects_events" validate constraint "projects_events_updated_by_id_fkey";

alter table "public"."projects_events_ressources" add constraint "projects_events_ressources_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_events_ressources" add constraint "projects_events_ressources_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_exemplarity_indicators" add constraint "projects_exemplarity_indicators_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_exemplarity_indicators" add constraint "projects_exemplarity_indicators_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_likes" add constraint "projects_likes_project_id_fkey" FOREIGN KEY (project_id) REFERENCES projects(id) not valid;

alter table "public"."projects_likes" validate constraint "projects_likes_project_id_fkey";

alter table "public"."projects_likes" add constraint "projects_likes_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."projects_likes" validate constraint "projects_likes_user_id_fkey";

alter table "public"."projects_likes" add constraint "projects_ratings_project_id_user_id_key" UNIQUE using index "projects_ratings_project_id_user_id_key";

alter table "public"."projects_likes" add constraint "projects_ratings_user_id_project_id_key" UNIQUE using index "projects_ratings_user_id_project_id_key";

alter table "public"."projects_materials" add constraint "projects_materials_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_materials" add constraint "projects_materials_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."projects_materials" validate constraint "projects_materials_updated_by_id_fkey";

alter table "public"."projects_materials_uses" add constraint "projects_materials_uses_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_materials_uses" add constraint "projects_materials_uses_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_publication_status" add constraint "projects_publication_status_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."projects_users" add constraint "projects_users_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."projects_users" validate constraint "projects_users_created_by_id_fkey";

alter table "public"."projects_users" add constraint "projects_users_modified_by_id_fkey" FOREIGN KEY (modified_by_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."projects_users" validate constraint "projects_users_modified_by_id_fkey";
...
alter table "public"."users_profiles" add constraint "users_profiles_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."users_projects_collections" add constraint "users_projects_collections_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."users_projects_collections_items" add constraint "users_projects_collections_items_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
alter table "public"."users_projects_collections_items" add constraint "users_projects_collections_items_user_id_fkey" FOREIGN KEY (user_id) REFERENCES users_profiles(user_id) not valid;

alter table "public"."users_projects_collections_items" validate constraint "users_projects_collections_items_user_id_fkey";

alter table "public"."users_roles" add constraint "users_roles_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) not valid;
...
return select (user_id) from public.users_roles
where role = 'nplex'
limit 1
...
new.updated_at = now();
new.updated_by_id = coalesce(auth.uid(), public.get_relegate_uid());
...
CREATE OR REPLACE FUNCTION public.user_has_role(VARIADIC roles user_role[])
 ...
 LANGUAGE plpgsql
 SECURITY DEFINER
AS $function$ begin if auth.uid() = null then return false;
...
using ((EXISTS ( SELECT 1
   FROM projects
  WHERE (projects.id = projects_likes.project_id))));
