...
alter table "public"."project_event_child_type" add constraint "project_event_child_type_created_by_id_fkey" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) ON DELETE SET DEFAULT not valid;
...
alter table "public"."project_event_child_type" add constraint "project_event_child_type_updated_by_id_fkey" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) ON DELETE SET DEFAULT not valid;
...
alter table "public"."project_exemplarity_indicator" add constraint "project_exemplarity_indicator_category_id_fkey" FOREIGN KEY (category_id) REFERENCES project_exemplarity_indicator_category(id) ON DELETE SET NULL not valid;
...
alter table "public"."project_site_usage_parent_category" add constraint "project_site_usage_parent_category_category_id_fkey" FOREIGN KEY (category_id) REFERENCES project_site_usage_category(id) ON DELETE CASCADE not valid;
...
alter table "public"."project_site_usage_parent_category" add constraint "project_site_usage_parent_category_fk" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) ON DELETE SET DEFAULT not valid;

alter table "public"."project_site_usage_parent_category" validate constraint "project_site_usage_parent_category_fk";

alter table "public"."project_site_usage_parent_category" add constraint "project_site_usage_parent_category_fk_1" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) ON DELETE SET DEFAULT not valid;

alter table "public"."project_site_usage_parent_category" validate constraint "project_site_usage_parent_category_fk_1";
...
alter table "public"."project_site_usage_parent_category" add constraint "project_site_usage_parent_category_usage_id_fkey" FOREIGN KEY (usage_id) REFERENCES project_site_usage(id) ON DELETE CASCADE not valid;
...
alter table "public"."project_type_parent_category" add constraint "project_type_parent_category_fk" FOREIGN KEY (created_by_id) REFERENCES users_profiles(user_id) ON DELETE SET DEFAULT not valid;

alter table "public"."project_type_parent_category" validate constraint "project_type_parent_category_fk";

alter table "public"."project_type_parent_category" add constraint "project_type_parent_category_fk_1" FOREIGN KEY (updated_by_id) REFERENCES users_profiles(user_id) ON DELETE SET DEFAULT not valid;

alter table "public"."project_type_parent_category" validate constraint "project_type_parent_category_fk_1";
...
alter table "public"."projects" add constraint "projects_category_id_fkey" FOREIGN KEY (category_id) REFERENCES project_category(id) ON DELETE SET NULL not valid;
...
alter table "public"."projects" add constraint "projects_implantation_mode_id_fkey" FOREIGN KEY (implantation_mode_id) REFERENCES project_implantation_mode(id) ON DELETE SET NULL not valid;

alter table "public"."projects" validate constraint "projects_implantation_mode_id_fkey";

alter table "public"."projects" add constraint "projects_site_ownership_id_fkey" FOREIGN KEY (site_ownership_id) REFERENCES project_site_ownership(id) ON DELETE SET NULL not valid;

alter table "public"."projects" validate constraint "projects_site_ownership_id_fkey";

alter table "public"."projects" add constraint "projects_site_usage_category_id_fkey" FOREIGN KEY (site_usage_category_id) REFERENCES project_site_usage_category(id) ON DELETE SET NULL not valid;

alter table "public"."projects" validate constraint "projects_site_usage_category_id_fkey";

alter table "public"."projects" add constraint "projects_site_usage_id_fkey" FOREIGN KEY (site_usage_id) REFERENCES project_site_usage(id) ON DELETE SET NULL not valid;
...
alter table "public"."projects" add constraint "projects_type_id_fkey" FOREIGN KEY (type_id) REFERENCES project_type(id) ON DELETE SET NULL not valid;
...
alter table "public"."projects_events" add constraint "projects_events_type_id_fkey" FOREIGN KEY (type_id) REFERENCES project_event_type(id) ON DELETE RESTRICT not valid;
...
alter table "public"."projects_exemplarity_indicators" add constraint "projects_exemplarity_indicators_exemplarity_indicator_id_fkey" FOREIGN KEY (exemplarity_indicator_id) REFERENCES project_exemplarity_indicator(id) ON DELETE CASCADE not valid;
...
alter table "public"."projects_likes_sums" add constraint "projects_likes_sums_fk" FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE not valid;
...
alter table "public"."projects_materials" add constraint "projects_materials_material_type_id_fkey" FOREIGN KEY (material_type_id) REFERENCES project_material_type(id) ON DELETE CASCADE not valid;

alter table "public"."projects_materials" validate constraint "projects_materials_material_type_id_fkey";

alter table "public"."projects_materials" add constraint "projects_materials_origin_id_fkey" FOREIGN KEY (origin_id) REFERENCES project_material_origin(id) ON DELETE CASCADE not valid;
...
alter table "public"."projects_materials_uses" add constraint "projects_materials_uses_material_use_id_fkey" FOREIGN KEY (material_use_id) REFERENCES project_material_use(id) ON DELETE CASCADE not valid;
...
alter table "public"."projects_users" add constraint "projects_users_project_id_fkey" FOREIGN KEY (project_id) REFERENCES projects(id) ON DELETE CASCADE not valid;
...
-- CREATE TRIGGER track_project_event_child_type_update AFTER UPDATE ON public.project_event_child_type FOR EACH ROW EXECUTE FUNCTION track_update();

-- CREATE TRIGGER track_event_type_update AFTER UPDATE ON public.project_event_type FOR EACH ROW EXECUTE FUNCTION track_update();

-- CREATE TRIGGER track_project_exemplarity_indicator_update AFTER UPDATE ON public.project_exemplarity_indicator FOR EACH ROW EXECUTE FUNCTION track_update();

-- CREATE TRIGGER track_project_exemplarity_indicator_category_update AFTER UPDATE ON public.project_exemplarity_indicator_category FOR EACH ROW EXECUTE FUNCTION track_update();
...
-- CREATE TRIGGER track_project_site_usage_parent_category_update BEFORE UPDATE ON public.project_site_usage_parent_category FOR EACH ROW EXECUTE FUNCTION track_update();

-- CREATE TRIGGER track_project_type_update BEFORE UPDATE ON public.project_type FOR EACH ROW EXECUTE FUNCTION track_update();

-- CREATE TRIGGER track_project_type_parent_category_update BEFORE UPDATE ON public.project_type_parent_category FOR EACH ROW EXECUTE FUNCTION track_update();
