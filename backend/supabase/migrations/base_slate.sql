...
create table "public"."project_sub_type" (
    "id" smallint generated by default as identity not null,
    "title" text not null,
    "description" text
);
...
alter table "public"."project_sub_type" enable row level security;

create table "public"."project_sub_type_parent_type" (
    "type_id" smallint not null,
    "sub_type_id" smallint not null
);


alter table "public"."project_sub_type_parent_type" enable row level security;
...
CREATE UNIQUE INDEX project_sub_type_title_key ON public.project_sub_type USING btree (title);

CREATE UNIQUE INDEX project_type_pkey ON public.project_type USING btree (id);

CREATE UNIQUE INDEX project_types_sub_types_type_id_sub_type_id_key ON public.project_sub_type_parent_type USING btree (type_id, sub_type_id);
...
alter table "public"."project_sub_type" add constraint "project_sub_type_pkey" PRIMARY KEY using index "project_sub_type_pkey";

alter table "public"."project_sub_type_parent_type" add constraint "project_sub_type_parent_type_pkey" PRIMARY KEY using index "project_sub_type_parent_type_pkey";
...
alter table "public"."project_sub_type" add constraint "project_sub_type_title_key" UNIQUE using index "project_sub_type_title_key";

alter table "public"."project_sub_type_parent_type" add constraint "project_sub_type_parent_type_sub_type_id_fkey" FOREIGN KEY (sub_type_id) REFERENCES project_sub_type(id) not valid;

alter table "public"."project_sub_type_parent_type" validate constraint "project_sub_type_parent_type_sub_type_id_fkey";
