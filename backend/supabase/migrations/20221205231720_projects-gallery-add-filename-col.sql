alter table "public"."projects_images" add column "file_name" text not null;
...
AS $function$
	...
	then
		insert into public.projects_images (id, project_id, updated_by_id, created_by_id, file_name)
