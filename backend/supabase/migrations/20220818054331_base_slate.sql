...
CREATE UNIQUE INDEX project_site_usage_by_category_pkey ON public.project_site_usage_by_category USING btree (usage_id, category_id);

CREATE UNIQUE INDEX project_site_usage_by_category_usage_id_category_id_key ON public.project_site_usage_by_category USING btree (usage_id, category_id);
...
alter table "public"."project_site_usage_by_category" add constraint "project_site_usage_by_category_category_id_fkey" FOREIGN KEY (category_id) REFERENCES project_site_usage_category(id) ON DELETE CASCADE not valid;

alter table "public"."project_site_usage_by_category" validate constraint "project_site_usage_by_category_category_id_fkey";

alter table "public"."project_site_usage_by_category" add constraint "project_site_usage_by_category_usage_id_category_id_key" UNIQUE using index "project_site_usage_by_category_usage_id_category_id_key";

alter table "public"."project_site_usage_by_category" add constraint "project_site_usage_by_category_usage_id_fkey" FOREIGN KEY (usage_id) REFERENCES project_site_usage(id) ON DELETE CASCADE not valid;

alter table "public"."project_site_usage_by_category" validate constraint "project_site_usage_by_category_usage_id_fkey";
